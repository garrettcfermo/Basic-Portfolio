...
5. Reference these screenshots for your site:
   ...
   ![Portfolio About](assets/images/readme_images/portfolio-about-me.png)

   ![Portfolio Contact](assets/images/readme_images/portfolio-contact.png)

   ![Portfolio Gallery](assets/images/readme_images/portfolio-gallery.png)
...
6. Dimensions:
   ...
   * Pro-tip: Use the [Page Ruler](https://chrome.google.com/webstore/detail/page-ruler/jlpkojjdgbllmedoapgfodplfhcbnbpn/related?hl=en) extension to measure the size of elements.
   ...
   ![Recommended Dimensions](assets/images/readme_images/Recommended-Dimensions.png)
